...
#ifndef FORAGINGTEMPCONTROLLER_H
#define FORAGINGTEMPCONTROLLER_H
...
class ForagingTempController : public TemplateEEController
{
    public:
    
        ForagingTempController(RobotWorldModel *wm);
        ~ForagingTempController();
