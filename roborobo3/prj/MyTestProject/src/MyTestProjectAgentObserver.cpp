...
MyTestProjectAgentObserver::MyTestProjectAgentObserver( )
{
}

MyTestProjectAgentObserver::MyTestProjectAgentObserver( RobotWorldModel *__wm )
{
	_wm = __wm;
}
...
void MyTestProjectAgentObserver::reset()
{
	// nothing to do.
}

void MyTestProjectAgentObserver::stepPre()
{
